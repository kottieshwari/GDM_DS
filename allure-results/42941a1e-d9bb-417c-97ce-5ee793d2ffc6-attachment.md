...
- dialog "Single Create Reads":
  - text: Single Create Reads
  - button
  - textbox "AMI Meter Number Total Usage Start Date End Date Profile Name Start Register Read Scalar RTC Interval RTC Message Format Read Source": DEV2207_1
  - text: AMI Meter Number
  - checkbox "Use Profile as absolute"
  - text: Use Profile as absolute
  - spinbutton
  - text: Total Usage
  - combobox: 07/01/2025 00:00
  - text: Start Date
  - combobox: 07/22/2025 00:00
  - text: End Date
  - checkbox "Show Profile Group"
  - text: Show Profile Group
  - combobox
  - button
  - text: Profile Name
  - spinbutton: "0"
  - text: Start Register Read
  - combobox: Select Channel
  - text: Select Channel Scalar RTC
  - combobox: Select Channel
  - text: Select Channel Interval RTC
  - combobox "Select Message Format"
  - button "dropdown trigger"
  - text: Message Format
  - textbox
  - text: Read Source
  - checkbox "Apply Random Factor"
  - text: Apply Random Factor
  - button "Cancel"
  - button "Save"
