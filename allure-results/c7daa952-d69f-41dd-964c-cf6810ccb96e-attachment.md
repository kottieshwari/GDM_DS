...
- tabpanel "Location":
    ...
    - rowgroup:
      ...
      - row "NL_0906_01 residential true 2025-06-01T15:10:33":
        ...
        - cell:
          ...
          - button
          - button
  - text: Showing 1 to 10 of 132 entries
  ...
  - dialog "Location Details":
    ...
    - button
    - textbox "Entity ID Entity Organization Entity TimeZone Is Active Start Date End Date Location Type status_code premise_id market_identifier gps_longitude gps_latitude classification_code commodity_type metering_type": LOC2107_3
    - text: Entity ID
    - textbox: US Energy Co.
    ...
    - button "dropdown trigger"
    - text: Location Type status_code premise_id market_identifier gps_longitude gps_latitude classification_code commodity_type metering_type
    - button "Cancel"
    - button "Save"
